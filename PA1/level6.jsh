...
MRQ mrq = new MRQ("Pick the fruits.", options, answers, new int[] { 2, 4, 0, 0 }); 
MRQ mrq = new MRQ("Pick the fruits.", options, answers, new int[] { 0, 0, 2, 4 });
MRQ mrq = new MRQ("Pick the fruits.", options, answers, new int[] { 0, 0, 0, 0 }); 
